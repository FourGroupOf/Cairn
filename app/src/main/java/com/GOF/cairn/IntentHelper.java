...
import com.GOF.cairn.ui.map.actAddL;
import com.GOF.cairn.ui.preferences.actFAQ;
...
public class IntentHelper { //helps to swap between screens
    ...
    public void openIntentAddL(Context context) {
        Intent i = new Intent(context, actAddL.class);
        context.startActivity(i);
    }
    public void openIntentFAQ(Context context) {
        Intent i = new Intent(context, actFAQ.class);
        context.startActivity(i);
    }
